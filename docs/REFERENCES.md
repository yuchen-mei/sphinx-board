...
| [Diodes DMN62D2UQ](https://www.diodes.com/assets/Datasheets/DMN62D2UQ.pdf) | I/O enable MOSFETs |
...
Experiment inputs are defined in [REQUIREMENTS.md](REQUIREMENTS.md): 0.75 V nominal Core, fixed 1.8 V I/O, approximately 5 W active core power, empirical boost operation around 1.0 V, active-high reset with a running clock, asynchronous reset release, and no specified inter-rail sequence constraint. These inputs do not constitute manufacturer absolute-maximum ratings.
