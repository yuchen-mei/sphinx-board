...
CONTROL_PIN_CONTRACT = {'C1001': {'1': '3V3_CTRL', '2': 'GND'},
 'C1002': {'1': '3V3_CTRL', '2': 'GND'},
 'C306': {'1': 'VIN12', '2': 'IO_EN_INHIBIT'},
 'C307': {'1': 'IO_EN', '2': 'GND'},
 'C506': {'1': '3V3_CTRL', '2': 'GND'},
 'C901': {'1': 'AUX5V', '2': 'GND'},
 'C902': {'1': '3V3_CTRL', '2': 'GND'},
 'C903': {'1': '3V3_CTRL', '2': 'GND'},
 'C904': {'1': 'PICO_3V3', '2': 'GND'},
 'C905': {'1': '3V3_CTRL', '2': 'GND'},
 'C906': {'1': '3V3_CTRL', '2': 'GND'},
 'C907': {'1': 'BOARD_NTC', '2': 'GND'},
 'J1': {'54': 'reset'},
 ...
 'Q901': {'1': 'CLEAR_REQUEST', '2': 'GND', '3': 'HW_FAULT_N'},
 'R1001': {'1': '3V3_CTRL', '2': 'SUPERVISOR_CT'},
 'R1002': {'1': '1V8', '2': 'IO_OV_SENSE'},
 'R1003': {'1': 'IO_OV_SENSE', '2': 'GND'},
 'R1004': {'1': 'UNUSED_P12', '2': 'GND'},
 'R1005': {'1': 'UNUSED_P13', '2': 'GND'},
 'R1006': {'1': 'UNUSED_P14', '2': 'GND'},
 'R1007': {'1': 'UNUSED_P15', '2': 'GND'},
 'R1008': {'1': 'UNUSED_P16', '2': 'GND'},
 'R1009': {'1': 'UNUSED_P17', '2': 'GND'},
 ...
 'R408': {'1': '3V3_CTRL', '2': 'BOARD_NTC'},
 'R409': {'1': 'BOARD_NTC', '2': 'GND'},
 ...
 'R901': {'1': 'PICO_3V3', '2': 'PICO_SDA'},
 'R902': {'1': 'PICO_3V3', '2': 'PICO_SCL'},
 'R903': {'1': 'CLEAR_REQUEST', '2': 'GND'},
 'SW502': {'1': 'HW_FAULT_N', '2': 'GND'},
 'SW601': {'1': 'RESET_BASE', '2': 'GND'},
 'U1001': {'1': '3V3_CTRL', '2': 'GND', '3': 'HW_FAULT_N', '4': 'GND', '5': '3V3_CTRL', '6': 'GND'},
 'U1002': {'1': 'HW_FAULT_N',
           '2': 'GND',
           '3': 'IO_OV_REF',
           '4': 'IO_OV_SENSE',
 ...
 'U401': {'1': 'PICO_SDA',
          '10': 'unconnected-(U401-GPIO7-Pad10)',
          '11': 'unconnected-(U401-GPIO8-Pad11)',
          '12': 'unconnected-(U401-GPIO9-Pad12)',
          '14': 'unconnected-(U401-GPIO10-Pad14)',
          '15': 'unconnected-(U401-GPIO11-Pad15)',
          '16': 'unconnected-(U401-GPIO12-Pad16)',
          '2': 'PICO_SCL',
          '20': 'unconnected-(U401-GPIO15-Pad20)',
          '32': 'unconnected-(U401-GPIO27_ADC1-Pad32)',
          '36': 'PICO_3V3',
          '39': 'PICO_VSYS',
          '4': 'unconnected-(U401-GPIO2-Pad4)',
          '5': 'unconnected-(U401-GPIO3-Pad5)',
          '6': 'unconnected-(U401-GPIO4-Pad6)',
          '7': 'unconnected-(U401-GPIO5-Pad7)',
          '9': 'unconnected-(U401-GPIO6-Pad9)'},
 'U501': {'1': 'HW_FAULT_N',
          '2': 'GND',
          '3': 'REF1V242',
          '4': 'CORE_OV_SENSE',
 ...
 'U901': {'1': 'AUX5V', '2': 'GND', '3': 'AUX5V', '4': 'unconnected-(U901-NC-Pad4)', '5': '3V3_CTRL'},
 'U902': {'1': '3V3_CTRL',
          '2': 'PMBUS_SDA',
          '3': 'PMBUS_SCL',
          '4': 'GND',
          ...
          '7': 'PICO_SDA',
          '8': 'PICO_3V3'},
 'U903': {'1': 'unconnected-(U903-INT_N-Pad1)',
          '10': 'HW_FAULT_N',
          '11': 'CORE_PG',
          '12': 'GND',
          '13': 'IO_VALID',
 ...
 'U904': {'1': 'GND',
          '10': 'PMBUS_SCL',
          '2': 'unconnected-(U904-ALERT_RDY_N-Pad2)',
          '3': 'GND',
          '4': 'BOARD_NTC',
          '5': '3V3_CTRL',
          '6': 'GND',
...
def main():
    ...
    exact_nets = (
        ...
        "PICO_3V3", "PICO_SDA", "PICO_SCL", "CLEAR_REQUEST", "SUPERVISOR_CT",
        "BOARD_NTC", "IO_OV_REF", "IO_OV_SENSE",
        "UNUSED_P12", "UNUSED_P13", "UNUSED_P14", "UNUSED_P15", "UNUSED_P16", "UNUSED_P17",
    )
    ...
    reset_parts = {
        ...
        "C901": "CL21B475KOFNNNE", "C902": "CL21B475KOFNNNE",
        "U901": "TLV75533PDBVR", "U902": "ISO1640BDR", "U903": "TCA9535PWR",
        "U904": "ADS1115IDGSR", "U1001": "TMP302BDRLR", "U1002": "TLV3011AIDBVR",
        "Q901": "DMN62D2UQ-7", "R1001": "RC0603FR-07100KL",
        "R1002": "RT0603BRD0712K6L", "R1003": "RT0603BRD0720KL",
    }
    ...
    if len(new_comps) != 247 or len(new_nets) != 146:
        errors.append("Current V2 component/net counts differ from 247/146.")
    # Every Pico signal except isolated I2C must be NC. Supply and ground are
    # the only other allowed connections; a stray direct diagnostic wire fails.
    pico_allowed = {"GND", "PICO_VSYS", "PICO_3V3", "PICO_SDA", "PICO_SCL"}
    for (ref, pin), net in new_pins.items():
        if ref == "U401" and net not in pico_allowed and not net.startswith("unconnected-"):
            errors.append(f"Pico physical pin {pin} directly touches board state: {net}")
        if ref == "U401" and net.startswith("unconnected-") and "no_connect" not in new_nodes[(ref, pin)].get("pintype", ""):
            errors.append(f"Pico unused pin {pin} lacks a deliberate NC marker")
    for pin, function in (("1", "G"), ("2", "S"), ("3", "D")):
        if new_nodes[("Q901", pin)].get("pinfunction") != f"{function}_{pin}":
            errors.append(f"Q901 physical pin {pin} must be {function}")
    ...
    report = {
        "review": "Current V2 autonomous power electrical contract and BOM audit",
        ...
        "connectivity": {
            ...
            "scope": "Independent control supply, isolated Pico interface, retained expander requests, board ADC, standalone thermal and IO overvoltage shutdown, STOP, run latch, all enable/reset gates and local/remote reset.",
        },
        "U504": {
        ...
        "fault_behavior": {
            ...
            "input_loss_limit": "Retention requires continuously valid board input. Complete board-power loss defaults OFF. Partial input brownout can reset regulator and control domains differently; it requires physical characterization. U509 remains diagnostic only.",
        },
        "bom": {
